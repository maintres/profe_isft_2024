...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-08-2024 a las 17:06:05
...
CREATE TABLE `licencias` (
  ...
  `idtipos_licencias` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `licencias` (`id`, `nombre`, `fechadeinicio`, `fechadefin`, `idprofesor`, `idtipos_licencias`) VALUES
(7, 'Pablo Esteban', '2024-08-02', '2024-09-03', 40, NULL);
